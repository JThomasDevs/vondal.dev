    ...
    return (
        ...
        <div className="bg-black font-mono text-center flex-col">
            ...
            <p className="text-content-text text-left body-text">
                <div className="pb-6">
                    I am currently learning about <a href="https://en.wikipedia.org/wiki/Client%E2%80%93server_model" target="_blank" rel="external noreferrer" className="text-htmlcssjs hover:underline">Client-Server</a> Development and <a href="https://en.wikipedia.org/wiki/Embedded_system" target="_blank" rel="external noreferrer" className="text-rust hover:underline">Embedded Systems</a> programming.
                </div>
                <div>
