    ...
    return (
        ...
        <div className="bg-black font-mono text-center">
            ...
            <p className="text-content-text text-left body-text pt-8">
                ...
                <br />
                <br />
                The project that I am most proud of is my <a href="https://github.com/JThomasDevs/Tkinter-Interactive-GUI-Demo" target="_blank" rel="noreferrer" className= "text-python hover:underline">Dynamic GUI</a> built with <a href="https://docs.python.org/3/library/tkinter.html" target="_blank" rel="noreferrer" className="text-tkinter hover:underline">Tkinter</a>.
                <br />
                <br />
